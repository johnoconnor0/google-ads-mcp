...
|----------|-----------|------|
| Batch Operations | 11 | tools/batch/mcp_tools_batch.py |
| Reporting & Analytics | 7 | tools/reporting/mcp_tools_reporting.py |
| Insights & Recommendations | 8 | tools/insights/mcp_tools_insights.py |
| Automation & Optimization | 10 | tools/automation/mcp_tools_automation.py |
| Audience & Remarketing | 12 | tools/audiences/mcp_tools_audiences.py |
| Conversion Tracking | 10 | tools/conversions/mcp_tools_conversions.py |
| Ad Extensions | 8 | tools/extensions/mcp_tools_extensions.py |
| Shopping Campaigns | 4 | tools/shopping_pmax/mcp_tools_shopping_pmax.py |
| Performance Max | 5 | tools/shopping_pmax/mcp_tools_shopping_pmax.py |
| Local Campaigns | 3 | tools/local_app/mcp_tools_local_app.py |
| App Campaigns | 3 | tools/local_app/mcp_tools_local_app.py |
| Campaign Management | 15+ | tools/campaigns/mcp_tools_campaigns.py |
| Ad Group Management | 10+ | tools/ad_groups/mcp_tools_ad_groups.py |
| Keyword Management | 10+ | tools/keywords/mcp_tools_keywords.py |
| Ad Management | 8+ | tools/ads/mcp_tools_ads.py |
| Bidding Management | 8+ | tools/bidding/mcp_tools_bidding.py |
