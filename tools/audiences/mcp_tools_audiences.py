...
from managers.audience_manager import (
    AudienceManager,
    UserListConfig,
    UserListType,
...
from utils.logger import performance_logger, audit_logger
    ...
    def google_ads_create_user_list(
        ...
        Example:
            google_ads_create_user_list(
                ...
                list_name="All Site Visitors",
                description="All visitors to our website",
                membership_days=90,
                list_type="RULE_BASED",
        ...
        with performance_logger.track_operation('create_user_list', customer_id=customer_id):
            try:
                ...
                result = audience_manager.create_user_list(
                    customer_id, config, ul_type, url_contains=url_contains
                )
